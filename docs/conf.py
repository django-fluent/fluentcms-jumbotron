...
latex_documents = [
    (master_doc, 'fluentcms-jumbotron.tex', 'fluentcms-jumbotron Documentation',
...
man_pages = [
    (master_doc, 'fluentcms-jumbotron', 'fluentcms-jumbotron Documentation',
     [author], 1)
]
